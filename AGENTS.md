...
Maintain a package-specific Mate extension for PHPStan workflows. Keep package docs, output descriptions, and troubleshooting guidance aligned with the actual implementation.
